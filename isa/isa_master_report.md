...
1. **The Life of a Token:** Track one token from embedding to final prediction (Residual norm, logit lens, cosine similarity).
2. **Head Dissection:** Split heads into core computational paths ($Q$, $K$, $V$, $OV$ circuits).
